...
func (h *Handler) setSessionCookies(c *gin.Context, value adminapp.Tokens) {
	...
	c.SetCookie(adminsession.PageSessionCookieName, value.AccessToken, cookieMaxAge(value.AccessTokenExpiresAt), adminsession.PageSessionCookiePath, "", secure, true)
}
...
func (h *Handler) clearSessionCookies(c *gin.Context) {
	...
	c.SetCookie(adminsession.PageSessionCookieName, "", -1, adminsession.PageSessionCookiePath, "", secure, true)
}
